...
function ViewClaimedAllocation() {
					...
					<div className="bg-white rounded-lg flex flex-col">
						...
						<div className="border-y border-black/20 p-8 flex flex-col gap-6">
							...
							<div className="flex  items-center gap-8">
								...
								<div className="text-lg  flex justify-center items-center border border-blue-700 rounded-md py-7 bg-indigo-100/80 w-full">
									Enter an address
								</div>
							</div>
						...
						<div className="flex flex-col gap-4 p-8">
							...
							<Button className="button-secondary w-full">Cancel</Button>
						</div>
					</div>
				</div>
				{/* ───── Mobile  ───── */}
				<div className="bg-black/75 flex items-end justify-center md:hidden fixed bottom-0 left-0 w-dvw h-screen">
					<div className="bg-white w-full h-5/6 rounded-t-lg flex flex-col">
						...
						<div className="border-y border-black/20 p-8 flex flex-col gap-6">
							...
							<div className="text-lg  flex justify-center items-center border border-blue-700 rounded-md py-7 bg-indigo-100/80">
								Enter an address
							</div>
							<div className="flex flex-col gap-4">
								<div>
